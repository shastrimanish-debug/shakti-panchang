...
import '../services/kalnirnay_service.dart';

class KalnirnayScreen extends StatefulWidget {
  const KalnirnayScreen({super.key});
  @override
  State<KalnirnayScreen> createState() => _KalnirnayScreenState();
}

class _KalnirnayScreenState extends State<KalnirnayScreen> {
  late int _year;
  late int _month;
  ...
  Widget build(BuildContext context) {
    final m = KalnirnayService.month(_year, _month);
    return Scaffold(
      appBar: AppBar(
        title: const Text('कालनिर्णय पंचांग'),
        actions: [
