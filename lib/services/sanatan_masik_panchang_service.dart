...
class SanatanMasikMonth {
  final int year;
  final int monthIndex;
  final String titleHi;
  final int vikramSamvat;
  final int firstWeekday;
  final List<SanatanMasikDay> days;
  const SanatanMasikMonth({
    required this.year,
...
/// Monthly panchang grid for Shakti Panchang (tithi, vrat badges, Vikram samvat).
class SanatanMasikPanchangService {
  ...
  static SanatanMasikMonth month(int year, int monthIndex) {
